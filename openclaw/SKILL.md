...
**まずユーザーへ案内すること：**
Slackでは、動画を送っただけだとエージェント側で実体を拾えないことがある。反応がない・処理が始まらない場合は、次を案内する。
1. まず動画をSlackに送信する
2. 送信後、その動画を右クリックする
3. **「ファイルのリンクをコピー」** を選ぶ
4. そのリンクをメッセージで送ってもらう

案内文の例：

```text
Slackでは動画添付だけだと取得できないことがあります。
一度動画を送信したあと、その動画を右クリックして「ファイルのリンクをコピー」を選び、リンクも一緒に送ってください。
```
